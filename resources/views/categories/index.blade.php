                    ...
                    <tbody class="divide-y divide-gray-800">
                        @foreach($categories as $category)
                            <tr class="hover:bg-white/5">
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-white">{{ $category->name }}</td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-400">{{ $category->parent ? $category->parent->name : 'None' }}</td>
                            ...
                            @if($category->children)
                                @foreach($category->children as $child)
                                    <tr class="hover:bg-white/5">
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-white pl-8">-- {{ $child->name }}</td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-400">{{ $category->name }}</td>
                                        <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
